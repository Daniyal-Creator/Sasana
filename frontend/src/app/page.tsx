  ...
  return (
    <>
      <div className="flex-1">
        ...
        <section className="relative z-20 mx-auto -mt-7 max-w-5xl px-3 sm:-mt-10 sm:px-6 lg:-mt-12 lg:px-8">
          <div className="rounded-full border border-border bg-surface shadow-xl transition-all duration-200">
            ...
            >
              ...
              <Link
                href="/check"
                data-hero-door
                className="group flex flex-1 items-center justify-center sm:justify-start gap-1.5 px-2 py-3 sm:gap-4 sm:px-6 sm:py-5 transition-all duration-200 active:scale-[0.98] first:rounded-l-full hover:bg-surface-sunken/80"
              >
                <div className="flex h-8 w-8 sm:h-11 sm:w-11 shrink-0 items-center justify-center rounded-full border border-border bg-surface-sunken text-text-secondary transition-all duration-200 group-hover:scale-105 group-hover:border-primary group-hover:bg-primary group-hover:text-primary-fg">
                  <Camera size={16} strokeWidth={1.75} aria-hidden className="sm:h-5 sm:w-5" />
                </div>
                <div className="min-w-0">
                  ...
                  <span className="block text-[11px] sm:text-sm font-semibold leading-tight text-text transition-colors group-hover:text-primary">
              ...
              <Link
                href="/assistant"
                data-hero-door
                className="group flex flex-1 items-center justify-center sm:justify-start gap-1.5 px-2 py-3 sm:gap-4 sm:px-6 sm:py-5 transition-all duration-200 active:scale-[0.98] hover:bg-surface-sunken/80"
              >
                <div className="flex h-8 w-8 sm:h-11 sm:w-11 shrink-0 items-center justify-center rounded-full border border-border bg-surface-sunken text-text-secondary transition-all duration-200 group-hover:scale-105 group-hover:border-primary group-hover:bg-primary group-hover:text-primary-fg">
                  <MessageCircle size={16} strokeWidth={1.75} aria-hidden className="sm:h-5 sm:w-5" />
                </div>
                <div className="min-w-0">
                  <span className="hidden lg:block text-[10px] sm:text-[11px] font-bold uppercase tracking-wider text-text-muted">
              ...
              <Link
                href="/explore"
                data-hero-door
                className="group flex flex-1 items-center justify-center sm:justify-start gap-1.5 px-2 py-3 sm:gap-4 sm:px-6 sm:py-5 transition-all duration-200 active:scale-[0.98] last:rounded-r-full hover:bg-surface-sunken/80"
              >
                <div className="flex h-8 w-8 sm:h-11 sm:w-11 shrink-0 items-center justify-center rounded-full border border-border bg-surface-sunken text-text-secondary transition-all duration-200 group-hover:scale-105 group-hover:border-primary group-hover:bg-primary group-hover:text-primary-fg">
                  <MapPin size={16} strokeWidth={1.75} aria-hidden className="sm:h-5 sm:w-5" />
                </div>
                <div className="min-w-0">
                  <span className="hidden lg:block text-[10px] sm:text-[11px] font-bold uppercase tracking-wider text-text-muted">
